...
import kotlinx.android.synthetic.main.activity_running_time_repeat.*

/**
 * Created by jason_samuel on 2018/3/2.
 * 时段定时重复
 */
class RunningTimeRepeatActivity : BaseActivity() {

    var runningTime: RunningTime? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_running_time_repeat)
        //initData()
        initToolBar()
        //initView()
        //initListener()
    ...
    private fun initToolBar() {
        ...
        tool_bar!!.title = ""
        // 使用自己的布局
        titleTextView.setText(R.string.repeat)
